const msgs =
{
    ...
    on_ended: "${dm.config.chat_settings.prefix.color}${dm.config.chat_settings.prefix.name} ${dm.config.chat_settings.body_color}" +
     ...
     "${dm.config.chat_settings.body_color}! ${dm.config.chat_settings.player_color}${winners} ${dm.config.chat_settings.body_color}won!",
    ...
    on_interval: "${dm.config.chat_settings.prefix.color}${dm.config.chat_settings.prefix.name} ${dm.config.chat_settings.body_color}" +
     ...
     "stay here, ${dm.config.chat_settings.player_color}${name}${dm.config.chat_settings.welcome_color}, and may the odds ever be in your favor.",
